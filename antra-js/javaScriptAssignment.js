...
// let players = [{ score: [3, 3, 0] }, { score: [3, 3, 3] }];
// let maxNum = players.length; //2
// let indexArr = []
...
//     })
// })
// These are the indexes of the targets that have been completed; Since all players need to complete, we only need the indexValue that equals the num of players. In this case 1.
...
//should contain index of the target that needs to be closed....AKA the scoreindex
